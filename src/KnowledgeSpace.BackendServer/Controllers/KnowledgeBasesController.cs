...
using KnowledgeSpace.ViewModels.Contents.Comments;
using KnowledgeSpace.ViewModels.Contents.KnowledgeBases;
using KnowledgeSpace.ViewModels.Contents.Reports;
using KnowledgeSpace.ViewModels.Contents.Votes;
...
{
    public class KnowledgeBasesController : BasesController
    {
        ...
        public async Task<IActionResult> PostKnowledgeBase([FromBody] KnowledgeBaseCreateRequest request)
        {
            ...
            if (request.Attachments != null && request.Attachments.Count > 0)
            {
                ...
                {
                    var attachmentEntity = await SaveFile(knowledgeBase.Id, item);
