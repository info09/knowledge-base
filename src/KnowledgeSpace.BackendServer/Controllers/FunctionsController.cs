...
{
    public class FunctionsController : BasesController
    {
        private readonly ApplicationDbContext _context;
        private readonly ILogger<ApplicationDbContext> _logger;

        public FunctionsController(ApplicationDbContext context, ILogger<ApplicationDbContext> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public async Task<IActionResult> DeleteFunction(string id)
        {
            ...
            var commands = _context.CommandInFunctions.Where(i => i.FunctionId == id);
            _context.RemoveRange(commands);
        ...
        public async Task<IActionResult> PostCommandToFunction(string functionId, [FromBody] CommandAssignRequest request)
        {
            ...
            if (result > 0)
            {
                return CreatedAtAction(nameof(GetById), new { request.CommandIds, functionId }, request);
            }
            else
            {
